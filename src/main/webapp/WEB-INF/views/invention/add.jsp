...
<div>
	<h5><fmt:message key="invention.add.title" bundle="${i18n}" /></h5>
</div>
<div class="row">
	<form action="" class="col-sm-8" method="post" data-loading="true">
		<jsp:include page="/WEB-INF/jspf/form-feedback.jsp">
			...
			<jsp:param name="successMessageKey" value="invention.add.success" />
			<jsp:param name="errorStatus" value="Notadded" />
			<jsp:param name="errorMessageKey" value="invention.add.error" />
		</jsp:include>
		...
		<div class="form-group">
			...
			<textarea cols="10" rows="10" class="form-control ${not empty fieldErrors.resume ? 'is-invalid' : ''}"
				id="resume" placeholder="<fmt:message key='placeholder.enterSummary' bundle='${i18n}'/>" name="resume">${not empty invention ? invention.resume : param.resume}</textarea>
